            ...
            <div className='flex justify-end gap-2 text-white text-xs items-start '>
              ...
              {!isLogin ? (
                ...
                <div className='flex gap-4 items-center'>
                  ...
                  <Link to={'/profile'} className='block p-0.5 background-avatar'>
                    <img className='block w-full' src='https://avatars.akamai.steamstatic.com/fef49e7fa7e1997310d705b2a6158ff8dc1cdfeb.jpg' alt='' />
                  </Link>
                </div>
              )}
            </div>
