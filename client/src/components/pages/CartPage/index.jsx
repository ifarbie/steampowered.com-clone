...
const CartPage = () => {
  ...
  const calculateTotalPrice = (carts) => {
    let total = 0;
    carts.forEach((cart) => {
      if (cart.PriceList.discount > 0) {
        total += discountedPrice(cart.PriceList.discount, parseInt(cart.PriceList.price));
      } else {
              ...
              <div className='cart_contents'>
                <div className='left_col'>
                    ...
                    <div className='game_card_container' key={cart.id}>
                      <div className='game_card'>
                        <div className='img_games'>
                          <img src={cart.PriceList.product.product_thumbnail} alt={cart.PriceList.product.name} />
                        </div>
                        <div className='detail_games'>
                          <div className='games_details'>
                            <div className='titles'>
                              {cart.PriceList.product.name} {cart.PriceList.offerName}
                            </div>
                            ...
                            <div className='row_notes layout_dd'>
                              <div className='dropdown_container'>
                                <div className='dropdown_layout dd_dialog_box dd_dialog_input'>
                                  <div className='dropdown'>
                                    <select name='option_gift' id='option_gift' className='dropdown'>
                              ...
                              <div className='crud_btn btn_add_rem'>
                                ...
                                <div className='remove_btn' onClick={() => handleRemoveCart(cart.id)}>
                                  Remove
                                </div>
                              </div>
                            </div>
                  ...
                  <div className='interaction_btn'>
                    ...
                    <button className='remove_container_btn' onClick={handleRemoveAllCarts}>
                      Remove all items
                    </button>
                  </div>
                </div>
            ...
            <div className='right_col'>
              <div className='payment_card_container'>
                <div className='row mb-10'>
                  ...
                  <div className='totalestimateprice'>{formatPrice(totalPrice)}</div>
                </div>
